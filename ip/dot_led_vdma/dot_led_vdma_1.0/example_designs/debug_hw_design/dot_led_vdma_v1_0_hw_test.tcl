# Runtime Tcl commands to interact with - dot_led_vdma_v1_0

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/dot_led_vdma_v1_0_include.tcl
...
# Test: S_AXI_L
# Create a write transaction at s_axi_l_addr address
create_hw_axi_txn w_s_axi_l_addr [get_hw_axis $jtag_axi_master] -type write -address $s_axi_l_addr -data $wdata_1
# Create a read transaction at s_axi_l_addr address
create_hw_axi_txn r_s_axi_l_addr [get_hw_axis $jtag_axi_master] -type read -address $s_axi_l_addr
# Initiate transactions
run_hw_axi r_s_axi_l_addr
run_hw_axi w_s_axi_l_addr
run_hw_axi r_s_axi_l_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_s_axi_l_addr]]
# Compare read data
if { $rdata_tmp == $wdata_1 } {
	puts "Data comparison test pass for - S_AXI_L"
} else {
	puts "Data comparison test fail for - S_AXI_L, expected-$wdata_1 actual-$rdata_tmp"
	inc ec
}
